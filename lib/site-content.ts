...
export const projects: Project[] = [
  {
    slug: "sodic-collaboration", title: { en: "SODIC", ar: "سوديك" },
    ...
    materials: [], outcome: { en: "Selected SODIC work shown without unsupported metrics or claims.", ar: "أعمال سوديك المختارة معروضة دون أرقام أو ادعاءات غير موثقة." }, elements: { en: "Cladding only", ar: "التكسية فقط" },
