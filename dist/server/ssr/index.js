...
var client_references_default = {
	"1a2e3044d30c": async () => {
		const m = await import("./assets/InquiryForm-BfEVLeEq.js");
		return { get "InquiryForm"() {
			return m["InquiryForm"];
		} };
	},
	"326fe58ccdc4": async () => {
		const m = await import("./assets/SiteHeader-DLHq1TsC.js");
		return {
			get "SiteHeader"() {
				return m["SiteHeader"];
			},
	...
	"33357993033b": async () => {
		const m = await import("./assets/ManufacturingLine-Bh24CYQI.js");
		return { get "ManufacturingLine"() {
			return m["ManufacturingLine"];
		} };
	},
	"5297feacba07": async () => {
		const m = await import("./assets/ShowroomProcess-BBs2c3Wm.js");
		return { get "ShowroomProcess"() {
			return m["ShowroomProcess"];
		} };
	},
	"726cfa7c07d1": async () => {
		const m = await import("./assets/ProjectExplorer-CDQFixPp.js");
	...
	"7bbb11e5bc50": async () => {
		const m = await import("./assets/NocturneCategoryStack-Dl8gOZqX.js");
		return { get "NocturneCategoryStack"() {
			return m["NocturneCategoryStack"];
		} };
	},
	"97e23c8fc95f": async () => {
		const m = await import("./assets/error-boundary-DeGMTQUv.js");
		return {
			get "ErrorBoundary"() {
	...
	"9fb86276be8f": async () => {
		const m = await import("./assets/image-BaiAfpMh.js");
		return { get "default"() {
			return m["default"];
		} };
	},
	"b178cf627e26": async () => {
		const m = await import("./assets/AdaptiveWebGL-BMB--xgc.js");
	...
	"c2747888630f": async () => {
		const m = await import("./assets/link-BNF6Wcuy.js").then((n) => n.n);
		return { get "default"() {
			return m["default"];
		} };
	},
	"d7d8178d8913": async () => {
		const m = await import("./assets/layout-segment-context-DkSY5s6n.js");
		return { get "LayoutSegmentProvider"() {
			return m["LayoutSegmentProvider"];
		} };
	},
	"f18800975cb3": async () => {
		const m = await import("./assets/ProjectStoryRail-Bt1BximT.js");
