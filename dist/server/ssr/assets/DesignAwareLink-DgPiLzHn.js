...
import { t as Link } from "./link-LlPHghJ8.js";
...
function DesignAwareLink({ href, children, ...props }) {
	const design = getDesign(useSearchParams().get("design") ?? void 0);
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Link, {
		href: typeof href === "string" && href.startsWith("/") ? withDesign(href, design) : href,
		...props,
		children
	});
}
//#endregion
export { DesignAwareLink, usePathname as t };
