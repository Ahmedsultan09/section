...
function getDraftSecret() {
	return "11eabc5a-9d60-4eb3-a38c-48a18edaeb0a";
}
/**
...
var NextURL = class NextURL {
	...
	*/
	get buildId() {
		return "e33ce5ed-182d-465a-b8f0-897d6d2440f7";
	}
};
...
*/
function appIsrCacheKey(pathname, suffix, buildId = "e33ce5ed-182d-465a-b8f0-897d6d2440f7") {
...
function createAppPageArtifactCompatibility(element, routePattern) {
	...
	return createArtifactCompatibilityEnvelope({
		...
		deploymentVersion: "e33ce5ed-182d-465a-b8f0-897d6d2440f7",
		rootBoundaryId
	});
}
/**
