globalThis.__VINEXT_LAZY_CHUNKS__ = ["assets/link-BRTnB_5J.js","assets/react-D0rAtT7z.js","assets/site-content-BoNLg5ES.js","assets/AdaptiveWebGL-DHHhEbBQ.js","assets/DesignAwareLink-DskLSoCA.js","assets/ImmersiveProcessStory-BS1Yq8-c.js","assets/ImmersiveWebGL-CPubvs0i.js","assets/InquiryForm-BldQ7KhI.js","assets/LocaleSwitch-DHoSkjyx.js","assets/ProcessStory-ByeLxkvQ.js","assets/ProjectExplorer-BhkUihSH.js","assets/ProjectStoryRail-BQsSmuv7.js","assets/Reveal-DR6lHcU_.js","assets/ShowroomProcess-C2qYIWLl.js","assets/three.module-LUj4KE5y.js","assets/image-ChxKFKzs.js","assets/layout-segment-context-zc8MfA1a.js","assets/router-VSTezusH.js"];
...
function getDraftSecret() {
	return "3a2c448d-7574-40dc-9db9-3de8b732d755";
}
/**
...
var NextURL = class NextURL {
	...
	*/
	get buildId() {
		return "e5cb3c1a-b3a2-4ca1-96db-fe20a041ab6a";
	}
};
...
*/
function appIsrCacheKey(pathname, suffix, buildId = "e5cb3c1a-b3a2-4ca1-96db-fe20a041ab6a") {
...
function createAppPageArtifactCompatibility(element, routePattern) {
	...
	return createArtifactCompatibilityEnvelope({
		...
		deploymentVersion: "e5cb3c1a-b3a2-4ca1-96db-fe20a041ab6a",
		rootBoundaryId
	});
}
/**
...
function getDesign(value) {
	return ENABLED_DESIGNS.includes(value) ? value : DEFAULT_DESIGN;
}
function withDesign(href, design) {
	const [path, hash] = href.split("#");
	return `${path}${path.includes("?") ? "&" : "?"}design=${design}${hash ? `#${hash}` : ""}`;
}
//#endregion
//#region components/DesignSwitcher.tsx
var labels = {
	editorial: {
		en: "Editorial",
		ar: "تحريري"
...
function DesignSwitcher({ locale, current, path = `/${locale}` }) {
	return /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("nav", {
		className: "design-switcher",
		"aria-label": locale === "ar" ? "اختيار اتجاه التصميم" : "Design direction",
		children: [/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("span", { children: locale === "ar" ? "الاتجاه" : "View" }), ENABLED_DESIGNS.map((design) => /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)(link_default, {
			className: current === design ? "active" : "",
			href: withDesign(path, design),
			"aria-current": current === design ? "page" : void 0,
			children: labels[design][locale]
		}, design))]
	});
}
//#endregion
//#region components/InquiryForm.tsx
var InquiryForm = /* @__PURE__ */ registerClientReference(() => {
	throw new Error("Unexpectedly client reference export 'InquiryForm' is called on server");
}, "1a2e3044d30c", "InquiryForm");
//#endregion
//#region components/JsonLd.tsx
function JsonLd({ data }) {
	return /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("script", {
...
var copy = {
	en: {
		nav: {
			...
			process: "Process",
			studio: "Studio",
			inquiry: "Discuss a project"
		},
		hero: {
			eyebrow: "SECTION / Made with wood",
			title: "Made with wood.\nBuilt for ambitious spaces.",
			body: "One team for design, custom making and installation.",
			primary: "Discuss a project",
			secondary: "View selected work",
			note: "Cairo / Design · Manufacture · Install"
		},
		proof: {
			eyebrow: "One accountable team",
			title: "From first line to final fit.",
			body: "You brief one team. We coordinate, make and install."
		},
		featured: {
			eyebrow: "Selected project",
			title: "The project tells the story.",
			link: "Open project"
		},
		capabilities: {
			eyebrow: "Browse by category",
			title: "Explore the work.",
			body: "Move through spaces, built elements and finishes.",
			view: "Open collection"
		},
		process: {
			eyebrow: "How work moves",
			title: "Four moves. One line.",
			body: "Scroll from idea to installation."
		},
		factory: {
			eyebrow: "Manufacturing",
			title: "Made here. Checked here.",
			body: "We build, assemble and check every piece before it travels to site.",
			facts: [
				"Review before production",
				"Sample before finish",
		...
		projects: {
			...
			body: "Four project studies. Client names appear only after approval.",
			all: "All",
			open: "View project"
		},
		materials: {
			eyebrow: "Materials & quality",
			title: "Chosen to last.",
			body: "Every board, finish and fitting is selected for the way the space will be used.",
			items: [
				"The right substrate",
				"An approved finish sample",
				"Hardware matched to use",
		...
		close: {
			...
			body: "Share the project, the stage and the deadline. We will take it from there.",
	...
	ar: {
		nav: {
			work: "الأعمال",
			capabilities: "المجموعات",
			process: "المراحل",
			studio: "الاستوديو",
			inquiry: "ناقش مشروعك"
		},
		hero: {
			eyebrow: "SECTION / مصنوع من الخشب",
			title: "مصنوع من الخشب.\nلمساحات بطموح كبير.",
			body: "فريق واحد للتصميم والتصنيع المخصص والتركيب.",
			primary: "ناقش مشروعك",
			secondary: "شاهد الأعمال",
			note: "القاهرة / تصميم · تصنيع · تركيب"
		},
		proof: {
			eyebrow: "فريق واحد مسؤول",
			title: "من أول خط إلى آخر تركيب.",
			body: "تعرض علينا المشروع. ننسق ونصنع ونركب."
		},
		featured: {
			eyebrow: "مشروع مختار",
			title: "المشروع يروي القصة.",
			link: "افتح المشروع"
		},
		capabilities: {
			eyebrow: "تصفح حسب الفئة",
			title: "استكشف الأعمال.",
			body: "انتقل بين المساحات والعناصر المصنوعة والتشطيبات.",
			view: "افتح المجموعة"
		},
		process: {
			eyebrow: "كيف يتحرك العمل",
			title: "أربع مراحل. خط واحد.",
			body: "مرّر من الفكرة إلى التركيب."
		},
		factory: {
			eyebrow: "التصنيع",
			title: "نصنع هنا. ونراجع هنا.",
			body: "نصنع ونجمع ونراجع كل قطعة قبل انتقالها إلى الموقع.",
			facts: [
				"مراجعة قبل الإنتاج",
				"عينة قبل التشطيب",
				"فحص قبل التسليم"
		...
		projects: {
			...
			title: "أعمال تستحق أن تفتحها.",
			body: "أربع دراسات مشروعات. تظهر أسماء العملاء بعد الاعتماد فقط.",
			all: "الكل",
			open: "شاهد المشروع"
		},
		materials: {
			eyebrow: "الخامات والجودة",
			title: "مختارة لتدوم.",
			body: "نختار كل لوح وتشطيب وإكسسوار حسب طريقة استخدام المساحة.",
			items: [
				"لوح مناسب للاستخدام",
				"عينة تشطيب معتمدة",
				"إكسسوارات تناسب الاستخدام",
				"فحص نهائي قبل التسليم"
			]
		},
		close: {
			eyebrow: "ابدأ بالمتطلبات",
			title: "أرسل لنا المتطلبات.",
			body: "شارك المشروع ومرحلته وموعده. وسنكمل من هناك.",
			action: "ناقش مشروعك"
		}
	}
};
...
function capabilityLabel(slug, locale) {
	return capabilities.find((capability) => capability.slug === slug)?.title[locale] ?? slug;
}
//#endregion
//#region lib/seo.ts
var SITE_URL = (process.env.NEXT_PUBLIC_SITE_URL ?? "https://section-furniture.com").replace(/\/$/, "");
var SITE_NAME = "SECTION";
var SEO_LAST_MODIFIED = /* @__PURE__ */ new Date("2026-07-18T00:00:00.000Z");
var seoCopy = {
	en: {
...
function alternates(locale, path = "") {
	return {
...
function localeMetadata(locale) {
	...
	return {
		...
		title: {
			default: text.siteTitle,
			template: text.titleTemplate
		},
		...
		openGraph: {
			...
			images: [{
				...
				width: 1680,
				height: 945,
				alt: `${SITE_NAME} — Made with wood. Built for ambitious spaces.`
			}]
		},
		twitter: {
		...
		verification: process.env.NEXT_PUBLIC_GOOGLE_SITE_VERIFICATION ? { google: process.env.NEXT_PUBLIC_GOOGLE_SITE_VERIFICATION } : void 0
	};
}
function pageMetadata({ locale, path, title, description, image }) {
	return {
		title,
		description,
...
function serviceSchema(locale, capability) {
	...
	return {
		...
		audience: {
			...
			audienceType: locale === "ar" ? "المطورون والمعماريون وفرق المشروعات" : "Developers, architects and project teams"
		}
	};
}
function projectSchema(locale, project) {
	...
	return {
		...
		url: absoluteUrl(localePath(locale, path)),
		inLanguage: locale,
		about: project.capabilities.map((capability) => ({
			"@type": "Thing",
			name: capability
		})),
...
//#endregion
//#region app/[locale]/inquiry/page.tsx
...
async function generateMetadata$5({ params }) {
	...
	return pageMetadata({
		locale,
		path: "/inquiry",
		title: seoCopy[locale].inquiryTitle,
		description: seoCopy[locale].inquiryDescription
	});
}
async function InquiryPage({ params, searchParams }) {
	const { locale } = await params;
	if (!isLocale(locale)) notFound();
	const design = getDesign((await searchParams)?.design);
	return /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("main", {
		className: `inquiry-page subpage design-${design}`,
		"data-design": design,
		children: [
			/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)(JsonLd, { data: [breadcrumbSchema(locale, [{
				name: locale === "ar" ? "الرئيسية" : "Home",
				path: ""
			}, {
				name: locale === "ar" ? "ناقش مشروعك" : "Discuss a project",
				path: "/inquiry"
			}]), {
				"@context": "https://schema.org",
				"@type": "ContactPage",
				name: seoCopy[locale].inquiryTitle,
				description: seoCopy[locale].inquiryDescription,
				url: absoluteUrl(localePath(locale, "/inquiry")),
				inLanguage: locale,
				about: { "@id": `${SITE_URL}/#organization` }
			}] }),
			/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)(DesignSwitcher, {
				locale,
				current: design,
				path: `/${locale}/inquiry`
			}),
			/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("aside", {
				className: "inquiry-intro",
				children: [
					/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("p", {
						className: "eyebrow",
						children: ["SECTION / ", locale === "ar" ? "استفسار مشروع" : "Project inquiry"]
					}),
					/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("h1", { children: locale === "ar" ? "ابدأ بما تحتاجه." : "Start with what you need." }),
					/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("p", { children: locale === "ar" ? "اختيارات بسيطة، ثم اسمك ورقم هاتفك. وإذا لم تكن متأكداً بعد، نساعدك في تحديد الخطوة التالية." : "A few simple choices, then your name and phone. If you are not sure yet, we can help shape the next step." }),
					/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("div", { children: [/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("span", { children: "01" }), locale === "ar" ? "لا قوائم طويلة أو بيانات غير ضرورية" : "No long forms or unnecessary details"] }),
					/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("div", { children: [/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("span", { children: "02" }), locale === "ar" ? "الملاحظات والملفات اختيارية" : "Notes and files are optional"] })
				]
			}),
			/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)(InquiryForm, { locale })
		]
	});
}
...
var DesignAwareLink = /* @__PURE__ */ registerClientReference(() => {
	throw new Error("Unexpectedly client reference export 'DesignAwareLink' is called on server");
}, "5f1b05c78786", "DesignAwareLink");
//#endregion
...
var driveMediaSeed = [
	{
		id: "k01a",
		driveFileId: "1Hv7GMYnP7qzss5Z-lElj6o72b7uX9kXh",
		sourceFolder: "Kitchens/Kitchen 1 (Obour)",
		sourceName: "IMG_9411.PNG",
		localSrc: "/drive/kitchens/kitchen-01-a.webp",
	...
	},
	{
		...
		sourceFolder: "Kitchens/Kitchen 1 (Obour)",
		sourceName: "IMG_9410.PNG",
		localSrc: "/drive/kitchens/kitchen-01-b.webp",
	...
	},
	{
		...
		sourceFolder: "Kitchens/Kitchen 1 (Obour)",
		sourceName: "IMG_9413.PNG",
		localSrc: "/drive/kitchens/kitchen-01-c.webp",
		originalMime: "image/png",
		authenticity: "verified-real",
		rights: "pending",
		publishStatus: "preview"
	},
	{
		...
		sourceFolder: "Kitchens/Kitchen 2 (Sahar)",
		sourceName: "a63f7de2-a084-400e-be9b-fe465d3af53c.jpg",
		localSrc: "/drive/kitchens/kitchen-02-a.webp",
		originalMime: "image/jpeg",
		authenticity: "verified-real",
		rights: "pending",
		publishStatus: "preview"
	},
	{
		...
		sourceFolder: "Kitchens/Kitchen 2 (Sahar)",
		sourceName: "e666bc45-4ac0-422d-9a8b-143c535db2d6.jpg",
		localSrc: "/drive/kitchens/kitchen-02-b.webp",
		originalMime: "image/jpeg",
		authenticity: "verified-real",
		rights: "pending",
		publishStatus: "preview"
	},
	{
		...
		sourceFolder: "Kitchens/Kitchen 3",
		sourceName: "IMG_0304.heif",
		localSrc: "/drive/kitchens/kitchen-03-a.webp",
	...
	},
	{
		...
		sourceFolder: "Kitchens/Kitchen 3",
		sourceName: "IMG_0298.heif",
		localSrc: "/drive/kitchens/kitchen-03-b.webp",
		originalMime: "image/heif",
		authenticity: "verified-real",
		rights: "pending",
		publishStatus: "preview"
	...
	{
		id: "k04a",
		driveFileId: "1mwygWZo1b9d0NXtkeETDIYffUGEMbHzh",
		sourceFolder: "Kitchens/Kitchen 4",
		sourceName: "IMG_7819.heif",
		localSrc: "/drive/kitchens/kitchen-04-a.webp",
		originalMime: "image/heif",
		authenticity: "verified-real",
		rights: "pending",
		publishStatus: "preview"
	...
	{
		id: "k04b",
		driveFileId: "1-NylTtxw8GzZBzCn3g1X66HBuRWiftA_",
		sourceFolder: "Kitchens/Kitchen 4",
		sourceName: "IMG_7817.heif",
		localSrc: "/drive/kitchens/kitchen-04-b.webp",
		originalMime: "image/heif",
		authenticity: "verified-real",
		rights: "pending",
		publishStatus: "preview"
	...
	{
		id: "k05a",
		driveFileId: "1MaFkgFgZLcYEl98ufqo7DwqBsGCUeCu3",
		sourceFolder: "Kitchens/Kitchen 5",
		sourceName: "768ab4de-7929-4097-a69b-488ab12ec550.jpeg",
		localSrc: "/drive/kitchens/kitchen-05-a.webp",
		originalMime: "image/jpeg",
		authenticity: "verified-real",
		rights: "pending",
		publishStatus: "preview"
	...
	{
		id: "k05b",
		driveFileId: "15vrqdtWjcMOQmTyZkm-S2m9usjMrvq1U",
		sourceFolder: "Kitchens/Kitchen 5",
		sourceName: "a08faa30-6467-48e2-9377-3ab5ac14639b.jpeg",
		localSrc: "/drive/kitchens/kitchen-05-b.webp",
		originalMime: "image/jpeg",
		authenticity: "verified-real",
		rights: "pending",
		publishStatus: "preview"
	...
	...[
		[
			"material-01",
			"17c5xZN7lUnoUQmZDo2t2BuPd7zPAvWBn",
			"IMG_0362.PNG",
			"image/png"
		],
		[
			"material-02",
			"12UB_raYGjIKzzeHz6mqgoaK9nXu88bS9",
			"IMG_0265.PNG",
			"image/png"
		],
		[
			"material-03",
			"16u6J76HoR1oCmKSKnx59lLB9-8xTWj7E",
			"IMG_5784.PNG",
			"image/png"
		],
		[
			"material-04",
			"1fFfDfJGWdBNjYShHvxC9YgA-Wl_gQe-U",
			"IMG_0216.PNG.jpg",
			"image/jpeg"
		],
		[
			"material-05",
			"1rLMWuQH931sIZ5BCapViU7iN5-BwNowv",
			"IMG_0215.PNG",
			"image/png"
		],
		[
			"material-06",
			"1pjguo7CPdfmQ7NQKeM1BRfPn-24Ccrqb",
			"IMG_0213.PNG",
			"image/png"
		],
		[
			"material-07",
			"1YZQp-kAxh0iJ_ZCgztnVH1bCrMHpvei6",
			"IMG_0211.PNG",
			"image/png"
		]
	].map(([id, driveFileId, sourceName, originalMime]) => ({
		id,
		driveFileId,
		sourceFolder: "Materials used",
		sourceName,
		localSrc: `/drive/materials/${id}.webp`,
		originalMime,
		authenticity: "verified-real",
		rights: "pending",
		publishStatus: "preview"
	...
	...[
		["d01", "19P_A2Q7w9AlxE67Y087iirRaHSiLY4Iq"],
		["d02", "1ksvIGXGPsAp7XrAMDAmronYjYpXQsqb-"],
		["d03", "1Nmvi7geXmXUvOgT6V6OycY8JX7m0pcAC"],
		["d04", "1_kID2fqpB4jF6pfUjdXtGKfKg3TCInf6"],
		["d05", "1oBpvLO3Mo3KhmLI4QnCI2YdaEopdEAdZ"],
		["d06", "12EE_jOrRRMUKqkXjATFjETlJkXYUM_HH"],
		["d07", "1VzGwxT4COzuoP-jqC0BwWIqj7UwWXmvR"],
		["d08", "1MLLFKBXiphhfEUXitbc4IC2eZnaILlIa"]
	].map(([id, driveFileId], index) => ({
		id,
		driveFileId,
		sourceFolder: "Dressing",
		sourceName: `Dressing image ${index + 1}`,
		localSrc: `/drive/dressing/dressing-0${index + 1}.webp`,
		originalMime: "image/heif",
		authenticity: "verified-real",
		rights: "pending",
		publishStatus: "preview"
...
function dedupeDriveMedia(records) {
	const seen = /* @__PURE__ */ new Set();
	return records.flatMap((record) => {
		...
		return [{
			...record,
			authenticity: aiLabelled ? "ai-concept" : record.authenticity,
			publishStatus: aiLabelled ? "quarantined" : record.publishStatus,
			orientation: record.orientation ?? "unknown",
			quality: record.quality ?? "editorial",
			derived: record.derived ?? { webp: record.localSrc }
		}];
	});
}
var driveMediaManifest = dedupeDriveMedia(driveMediaSeed);
function driveSrc(id) {
	return driveMediaManifest.find((item) => item.id === id)?.localSrc ?? "/assets/217375_739589.jpeg";
}
//#endregion
//#region lib/showroom-content.ts
var collectionPieces = [
	{
		...
		story: {
			en: "A calm fitted composition where storage, preparation and appliance zones read as one architectural line.",
			ar: "تكوين هادئ ومتكامل يجمع التخزين والتحضير والأجهزة في خط معماري واحد."
		},
		application: {
			en: "Residential kitchen",
			ar: "مطبخ سكني"
		},
		scope: {
			en: "Fitted cabinetry and coordinated installation",
			ar: "خزائن مدمجة وتركيب منسق"
		},
		media: [
			driveSrc("k01a"),
			driveSrc("k01b"),
			driveSrc("k01c"),
			"/drive/kitchens/kitchen-01-d.webp",
			"/drive/kitchens/kitchen-01-e.webp"
		],
	...
	},
	{
		...
		story: {
			en: "A compact kitchen study shaped around clear circulation, concealed storage and an easy everyday rhythm.",
			ar: "دراسة لمطبخ مدمج تتشكل حول حركة واضحة وتخزين هادئ وإيقاع يومي سهل."
		},
		application: {
		...
		scope: {
			en: "Cabinetry development and fitting",
			ar: "تطوير الخزائن وتركيبها"
		},
		media: [
			driveSrc("k02a"),
			driveSrc("k02b"),
			"/drive/kitchens/kitchen-02-c.webp",
			"/drive/kitchens/kitchen-02-d.webp"
		],
	...
	},
	{
		...
		story: {
			en: "A material-led kitchen package developed from site dimensions into a precise fitted envelope.",
			ar: "حزمة مطبخ تقودها الخامة وتتطور من أبعاد الموقع إلى غلاف دقيق ومتكامل."
		},
		application: {
			en: "Made-to-fit kitchen",
			ar: "مطبخ مصمم للمقاس"
		},
		scope: {
			en: "Survey, detailing and production",
			ar: "رفع مقاسات وتفاصيل وتصنيع"
		},
		media: [driveSrc("k03a"), driveSrc("k03b")],
	...
	},
	{
		...
		story: {
			en: "A restrained storage system designed to keep the room visually quiet while every function stays close at hand.",
			ar: "نظام تخزين هادئ بصرياً يحافظ على قرب كل وظيفة وسهولة الوصول إليها."
		},
		application: {
		...
		scope: {
			en: "Joinery manufacturing and fitting",
			ar: "تصنيع نجارة وتركيب"
		},
		media: [driveSrc("k04a"), driveSrc("k04b")],
		sourceFolderIds: ["13xG1rK3o4rdBb46kbVLMR_b2yflBEiE7"],
		status: "preview"
	},
	{
		slug: "kitchen-05",
		...
		story: {
			en: "A practical kitchen sequence balancing durable surfaces with a clean, composed elevation.",
			ar: "تسلسل عملي يوازن بين الأسطح المتينة وواجهة نظيفة ومتزنة."
		},
		application: {
			en: "Residential kitchen",
			ar: "مطبخ سكني"
		...
		scope: {
			en: "Production and coordinated delivery",
			ar: "تصنيع وتسليم منسق"
		},
		media: [
			driveSrc("k05a"),
			driveSrc("k05b"),
			"/drive/kitchens/kitchen-05-c.webp",
			"/drive/kitchens/kitchen-05-d.webp"
		],
		sourceFolderIds: ["1Va7QqpjC6Pmchnseo37B_tZq4kPiresk"],
		status: "preview"
	},
	{
		slug: "glass-frame-dressing",
		collection: "dressing-rooms",
		title: {
			en: "Glass-frame Dressing Room",
			ar: "غرفة ملابس بإطارات زجاجية"
		},
		story: {
			en: "A full-height wardrobe system combining illuminated interiors, glass fronts and accessible storage hardware.",
			ar: "نظام خزائن بارتفاع كامل يجمع الإضاءة الداخلية والواجهات الزجاجية وإكسسوارات التخزين العملية."
		},
		application: {
			en: "Bedroom dressing wall",
			ar: "حائط ملابس لغرفة نوم"
		},
		scope: {
			en: "Wardrobes, lighting integration and fitting",
			ar: "خزائن ودمج إضاءة وتركيب"
		},
		media: [
			driveSrc("d08"),
			driveSrc("d04"),
		...
		sourceFolderIds: ["1-1au0sX3ciSYnzZ-HYwa3OzE9D-q0q4X"],
		status: "preview"
	},
	{
		slug: "walk-in-dressing",
		collection: "dressing-rooms",
		title: {
			en: "Walk-in Dressing Room",
			ar: "غرفة ملابس داخلية"
		},
		story: {
			en: "A room-scale storage system where lighting, hanging, drawers and display zones form a continuous sequence.",
			ar: "نظام تخزين بحجم الغرفة تتصل فيه الإضاءة والتعليق والأدراج ومساحات العرض في تسلسل واحد."
		},
		application: {
			en: "Walk-in wardrobe",
			ar: "خزانة ملابس داخلية"
		},
		scope: {
			en: "Internal planning, cabinetry and installation",
			ar: "تخطيط داخلي وخزائن وتركيب"
		},
		media: [
			driveSrc("d06"),
			driveSrc("d05"),
...
var partnerLogos = [
	{
		id: "karim-magdy",
		name: "Karim Magdy",
		src: "/drive/partners-transparent/partner-01.png",
		driveFileId: "1IiQg5vYq1_OJQ4qMskBPi5tO3L2LL7bo",
		kind: "collaborator",
		preferredSurface: "dark",
		approval: "preview"
	},
	{
		id: "taj",
		name: "Taj Design House",
		src: "/drive/partners-transparent/partner-02.png",
		driveFileId: "1mwUeY1oHD95mEIMQE_lz4qJiKzevsnbP",
		kind: "collaborator",
	...
	},
	{
		id: "mys",
		name: "MYS",
		src: "/drive/partners-transparent/partner-03.png",
		driveFileId: "1QrmYNK6hGxTetEZSQSWGcTBzsjd5LgF4",
		kind: "collaborator",
		preferredSurface: "dark",
		approval: "preview"
	},
	{
		id: "nawara",
		name: "Nawara — Alaa Ezzat",
		src: "/drive/partners-transparent/partner-04.png",
		driveFileId: "1zSKp_VH6g6s3Hxxt5LzjQR0jGhkStk_o",
		kind: "collaborator",
		preferredSurface: "light",
		approval: "preview"
	},
	{
		id: "mai-saad",
		name: "Mai Saad Designs",
		src: "/drive/partners-transparent/partner-05.png",
		driveFileId: "1fGnufPbJE1ehgO58NgssAFAGqSygkJEy",
		kind: "collaborator",
		preferredSurface: "dark",
		approval: "preview"
	},
	{
		id: "ahmad-elsherif",
		name: "Ahmad Elsherif Designs",
		src: "/drive/partners-transparent/partner-06.png",
		driveFileId: "1-BcvpWLz8KUwOR7uwWLMf-gBMyBRNbXs",
		kind: "collaborator",
		preferredSurface: "dark",
		approval: "preview"
	},
	{
		id: "ra",
		name: "RA Interior Design",
		src: "/drive/partners-transparent/partner-07.png",
		driveFileId: "1Jc9w8yMxhyAzNDk-_dKTPitLaLlfUIy3",
		kind: "collaborator",
		preferredSurface: "light",
		approval: "preview"
	},
	...
	{
		id: "amaken",
		name: "Amaken Contracting",
		src: "/drive/partners-transparent/partner-09.png",
		driveFileId: "1AeawK1pm8GH1Jfuiy9d1v7zvTs61xs-1",
		kind: "collaborator",
		preferredSurface: "light",
		approval: "preview"
	}
];
function piecesFor(collection) {
	return collectionPieces.filter((piece) => piece.collection === collection && piece.status !== "quarantined");
}
var showroomCopy = {
	en: {
		partners: "People we work with",
		partnerNote: "Designers, studios and delivery partners",
		similar: "Discuss something similar",
		pieceLabel: "Selected project piece"
	},
	ar: {
		partners: "شركاء العمل",
		partnerNote: "مصممون واستوديوهات وشركاء تنفيذ",
		similar: "ناقش مشروعاً مشابهاً",
		pieceLabel: "قطعة مختارة من مشروع"
	}
};
//#endregion
//#region components/PartnerMarquee.tsx
function PartnerMarquee({ locale }) {
	...
	return /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("section", {
		...
		children: [/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("div", {
			className: "partner-proof-head",
			children: [/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("p", {
				id: "partner-proof-title",
				children: showroomCopy[locale].partners
			}), /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("span", { children: showroomCopy[locale].partnerNote })]
			...
			children: /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("div", {
				...
				children: items.map((partner, index) => /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("figure", {
					className: `partner-logo ${partner.preferredSurface}`,
					"aria-hidden": index >= partnerLogos.length,
					children: /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)(image_default, {
						unoptimized: true,
						src: partner.src,
						alt: index < partnerLogos.length ? partner.name : "",
						width: 720,
						height: 320,
						sizes: "(max-width: 700px) 170px, 220px"
					})
				}, `${partner.id}-${index}`))
			})
		})]
...
function SiteFooter({ locale }) {
	return /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("footer", {
		...
		children: [
			/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)(PartnerMarquee, { locale }),
			/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("div", { children: [/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)(Wordmark, { tone: "light" }), /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("p", { children: locale === "ar" ? "مصنوع من الخشب. لمَساحات بطموح كبير." : "Made with wood. Built for ambitious spaces." })] }),
			/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("div", {
				className: "footer-links",
				children: [
					/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)(DesignAwareLink, {
						href: `/${locale}/projects`,
						children: locale === "ar" ? "الأعمال" : "Projects"
					}),
					/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)(DesignAwareLink, {
						href: `/${locale}/inquiry`,
						children: locale === "ar" ? "ناقش مشروعك" : "Discuss a project"
					}),
					/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("a", {
						href: "tel:+201272333832",
						children: "+20 127 233 3832"
					}),
					/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("address", { children: [/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("span", { children: locale === "ar" ? "المعرض — سيلفر ستار داون تاون مول، القاهرة الجديدة" : "Showroom — Silver Star Downtown Mall, New Cairo" }), /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("span", { children: locale === "ar" ? "المصنع — شارع الترولي، المرج، القاهرة" : "Factory — Trolly Street, El-Marg, Cairo" })] })
				]
			}),
			/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("div", {
				...
				children: [/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("span", { children: [
					...
					" SECTION"
				] }), /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("span", { children: locale === "ar" ? "القاهرة، مصر" : "Cairo, Egypt" })]
			})
		]
	});
}
...
var layout_exports$1 = /* @__PURE__ */ __exportAll({
	default: () => $$wrap_LocaleLayout,
	generateMetadata: () => generateMetadata$4,
	generateStaticParams: () => generateStaticParams$2,
	viewport: () => viewport
});
function generateStaticParams$2() {
...
async function LocaleLayout({ children, params }) {
	...
	return /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("html", {
		...
		children: /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("body", { children: [/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)(JsonLd, { data: [organizationSchema(locale), websiteSchema(locale)] }), /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("div", {
			className: "locale-shell",
			children: [
				/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)(SiteHeader, { locale }),
				children,
...
var $$wrap_LocaleLayout = /* @__PURE__ */ __vite_rsc_wrap_css__$1(LocaleLayout, "default");
...
var ProjectExplorer = /* @__PURE__ */ registerClientReference(() => {
	throw new Error("Unexpectedly client reference export 'ProjectExplorer' is called on server");
}, "726cfa7c07d1", "ProjectExplorer");
//#endregion
//#region components/ProjectStoryRail.tsx
var ProjectStoryRail = /* @__PURE__ */ registerClientReference(() => {
	throw new Error("Unexpectedly client reference export 'ProjectStoryRail' is called on server");
}, "f18800975cb3", "ProjectStoryRail");
//#endregion
//#region app/[locale]/projects/page.tsx
...
async function ProjectsPage({ params, searchParams }) {
	const { locale } = await params;
	if (!isLocale(locale)) notFound();
	const design = getDesign((await searchParams)?.design);
	return /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("main", {
		className: `subpage projects-page design-${design}`,
		"data-design": design,
		children: [
			/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)(JsonLd, { data: [breadcrumbSchema(locale, [{
				name: locale === "ar" ? "الرئيسية" : "Home",
				...
				name: locale === "ar" ? "المشروعات" : "Projects",
				path: "/projects"
			}]), {
				"@context": "https://schema.org",
				"@type": "CollectionPage",
				name: seoCopy[locale].projectsTitle,
				description: seoCopy[locale].projectsDescription,
			...
			/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("header", {
				...
				children: [
					/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("p", {
						className: "eyebrow",
						children: ["SECTION / ", locale === "ar" ? "الأعمال" : "Work"]
					}),
					/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("h1", { children: locale === "ar" ? "مشروعات تروي كيف نعمل." : "Projects that show how we work." }),
					/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("p", { children: locale === "ar" ? "قصص مختارة بنطاق واضح وصور موثوقة، من التصور حتى التركيب." : "Selected stories with clear scope and verified imagery, from concept through installation." })
				]
			}),
			/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("section", {
				className: "projects-story-section section-pad",
				children: /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)(ProjectStoryRail, { locale })
			}),
			/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)(ProjectExplorer, { locale })
		]
	});
}
//#endregion
//#region app/[locale]/capabilities/[slug]/page.tsx
var page_exports$4 = /* @__PURE__ */ __exportAll({ default: () => LegacyCapabilityRedirect });
async function LegacyCapabilityRedirect({ params }) {
	const { locale, slug } = await params;
	redirect(`/${locale}/collections/${slug}`);
}
//#endregion
//#region app/[locale]/collections/[slug]/page.tsx
var page_exports$3 = /* @__PURE__ */ __exportAll({
	default: () => CollectionPage,
	generateMetadata: () => generateMetadata$2,
	generateStaticParams: () => generateStaticParams$1
});
function generateStaticParams$1() {
	return locales.flatMap((locale) => capabilities.map((collection) => ({
		locale,
...
async function generateMetadata$2({ params }) {
	...
	return pageMetadata({
		...
		title,
		description: collection.intro[locale]
	});
}
async function CollectionPage({ params, searchParams }) {
	...
	return /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("main", {
		className: `capability-detail subpage design-${design}`,
		"data-design": design,
		children: [
			/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)(DesignSwitcher, {
				locale,
			...
			/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)(JsonLd, { data: [
			...
			/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("header", {
				...
				children: [/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("div", { children: [
					/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("p", {
						className: "eyebrow",
						children: [
							locale === "ar" ? "مجموعات SECTION" : "SECTION collection",
							" / ",
							collection.number
						]
					}),
					/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("h1", { children: collection.title[locale] }),
					/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("p", { children: collection.intro[locale] }),
					/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)(DesignAwareLink, {
						className: "button-yellow",
						href: `/${locale}/inquiry`,
						children: [locale === "ar" ? "ناقش نطاقك" : "Discuss your scope", /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("span", { children: "↗" })]
					})
				] }), /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("div", {
					className: "capability-hero-media",
					children: /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)(image_default, {
						unoptimized: true,
						src: image.src,
			...
			/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("section", {
				className: "capability-spec section-pad",
				children: [
					/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)(SpecList, {
						number: "01",
						title: locale === "ar" ? "التطبيقات" : "Applications",
						items: collection.applications.map((item) => item[locale])
					}),
					/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)(SpecList, {
						number: "02",
						title: locale === "ar" ? "الخامات" : "Materials",
						items: collection.materials.map((item) => item[locale])
					}),
					/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)(SpecList, {
						number: "03",
						title: locale === "ar" ? "مسار العمل" : "Delivery path",
						items: collection.process.map((item) => item[locale])
					})
				]
			}),
			/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("section", {
				className: "collection-pieces section-pad",
				"aria-labelledby": "collection-pieces-title",
				children: [/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("header", { children: [
					/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("p", {
						className: "eyebrow",
						children: showroomCopy[locale].pieceLabel
					}),
					/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("h2", {
						id: "collection-pieces-title",
						children: locale === "ar" ? "تفاصيل تستحق الاستكشاف." : "Pieces worth exploring."
					}),
					/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("span", { children: locale === "ar" ? "كل قطعة مرجع يمكن تطويره وفقاً لاحتياجات مشروعك." : "Each piece is a made-to-order reference that can be developed for your project brief." })
				] }), /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("div", {
						...
						children: [
							/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("div", {
								...
								children: [/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("span", { children: String(index + 1).padStart(2, "0") }), /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("div", { children: [
									...
									/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("strong", { children: piece.story[locale] })
								] })]
							}),
							/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("div", {
								className: "collection-piece-gallery",
								children: piece.media.map((src, mediaIndex) => /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("figure", { children: [/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)(image_default, {
									unoptimized: true,
									src,
									alt: `${piece.title[locale]} — ${mediaIndex + 1}`,
									fill: true,
									sizes: "(max-width: 760px) 82vw, 38vw"
								}), /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("figcaption", { children: piece.scope[locale] })] }, src))
							}),
							/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)(DesignAwareLink, {
								href: `/${locale}/inquiry`,
			...
			related.length > 0 && /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("section", {
				className: "related-projects section-pad",
				children: [/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("p", {
					className: "eyebrow",
					children: locale === "ar" ? "دراسات مرتبطة" : "Related studies"
				}), related.map((project) => /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)(DesignAwareLink, {
					href: `/${locale}/projects/${project.slug}`,
					children: [
						/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("span", { children: project.sectorLabel[locale] }),
						/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("h2", { children: project.title[locale] }),
...
function SpecList({ number, title, items }) {
	return /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("article", { children: [
		/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("p", { children: number }),
		/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("h2", { children: title }),
		/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("ul", { children: items.map((item) => /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("li", { children: item }, item)) })
	] });
}
//#endregion
//#region app/[locale]/projects/[slug]/page.tsx
...
function generateStaticParams() {
	return locales.flatMap((locale) => projects.map((project) => ({
		locale,
		slug: project.slug
	})));
}
async function generateMetadata$1({ params }) {
	...
	return pageMetadata({
		...
		title,
		description: project.summary[locale],
		image: getMedia(project.media[0]).src
	});
}
async function ProjectPage({ params, searchParams }) {
	...
	return /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("main", {
		className: `project-detail subpage design-${design}`,
		"data-design": design,
		children: [
			/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)(JsonLd, { data: [projectSchema(locale, project), breadcrumbSchema(locale, [
				{
					name: locale === "ar" ? "الرئيسية" : "Home",
					path: ""
				},
			...
			/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("header", {
				...
				children: [/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("div", {
					...
					children: [
						...
						/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("h1", { children: project.title[locale] }),
						/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("span", { children: project.client[locale] })
					]
				})]
			}),
			/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("section", {
				className: "project-overview section-pad",
				children: [/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("div", { children: [/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("p", {
					className: "eyebrow",
					children: locale === "ar" ? "نظرة عامة" : "Overview"
				}), /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("h2", { children: project.summary[locale] })] }), /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("div", {
					className: "project-facts",
					children: [/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("p", { children: project.scope[locale] }), /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("dl", { children: [
						/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("div", { children: [/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("dt", { children: locale === "ar" ? "القطاع" : "Sector" }), /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("dd", { children: project.sectorLabel[locale] })] }),
						/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("div", { children: [/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("dt", { children: locale === "ar" ? "الموقع" : "Location" }), /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("dd", { children: project.location[locale] })] }),
						/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("div", { children: [/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("dt", { children: locale === "ar" ? "العناصر" : "Elements" }), /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("dd", { children: project.capabilities.map((capability) => capabilityLabel(capability, locale)).join(" · ") })] })
					] })]
				})]
			}),
			/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("aside", {
				className: "verification-note",
				children: [/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("span", { children: "!" }), /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("p", { children: project.verificationNote[locale] })]
			}),
			/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("section", {
				...
				children: project.media.map((mediaId, mediaIndex) => {
					...
					return /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("figure", {
						className: mediaIndex % 3 === 1 ? "portrait" : "landscape",
			...
			/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("section", {
				className: "project-delivery section-pad",
				children: [/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("div", { children: [/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("p", {
					className: "eyebrow",
					children: locale === "ar" ? "مسؤوليتنا" : "Our responsibility"
				}), /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("h2", { children: project.outcome[locale] })] }), /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("div", { children: [/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("ul", { children: project.responsibilities.map((item) => /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("li", { children: item[locale] }, item.en)) }), /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("ul", { children: project.materials.map((item) => /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("li", { children: item[locale] }, item.en)) })] })]
			}),
			/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)(DesignAwareLink, {
				className: "next-project section-pad",
				href: `/${locale}/projects/${next.slug}`,
				children: [
					/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("p", { children: locale === "ar" ? "المشروع التالي" : "Next project" }),
					/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("h2", { children: next.title[locale] }),
...
})(import_react_react_server.default, assetsManifest.serverResources["app/(root)/layout.tsx"], void 0, "vite-rsc/importer-resources");
//#endregion
//#region app/(root)/layout.tsx
var layout_exports = /* @__PURE__ */ __exportAll({ default: () => $$wrap_RedirectLayout });
...
var $$wrap_RedirectLayout = /* @__PURE__ */ __vite_rsc_wrap_css__(RedirectLayout, "default");
...
var inquiryAttachments = sqliteTable("inquiry_attachments", {
	id: text("id").primaryKey(),
...
//#endregion
//#region lib/inquiry-security.ts
...
async function signFileAccess(key, expires, secret) {
...
async function verifyFileAccess(key, expires, signature, secret) {
...
//#endregion
//#region app/api/inquiries/route.ts
...
function isRateLimited(ip) {
	const now = Date.now();
	const recent = (rateWindow.get(ip) ?? []).filter((time) => now - time < 600 * 1e3);
	recent.push(now);
...
async function POST(request) {
	...
	if (value(data, "website")) return Response.json({
	...
	let capabilities;
	try {
		capabilities = JSON.parse(value(data, "capabilities"));
	} catch {
		capabilities = [];
	}
	...
	const files = data.getAll("files").filter((entry) => entry instanceof File && entry.size > 0);
	...
	await db.insert(inquiries).values({
		...
		createdAt,
		status: "received",
		locale: value(data, "locale") === "ar" ? "ar" : "en",
		name: value(data, "name"),
		company: value(data, "company") || "Website inquiry",
		role: value(data, "role") || "Not specified",
		email: email || "Not provided",
		phone: value(data, "phone"),
		preferredContact: "phone",
		sector: value(data, "sector") || "Not specified",
		projectName,
		location: value(data, "location") || "Not specified",
		projectStage: value(data, "projectStage") || "not-sure-yet",
		capabilities: JSON.stringify(capabilities),
		serviceScope: value(data, "serviceScope") || "not-sure-yet",
		scale: value(data, "scale") || "Not specified",
		drawingsStatus: value(data, "drawingsStatus") || "Not specified",
		roleDetail: value(data, "roleDetail") || null,
		targetDelivery: value(data, "targetDelivery") || "Not specified",
		budgetBand: value(data, "budgetBand") || "Not determined",
		procurementStatus: value(data, "procurementStatus") || "Not specified",
		decisionTimeline: value(data, "decisionTimeline") || "Not specified",
		brief,
		consent: true,
		sourceIp: ip,
	...
	try {
		for (const file of files) {
			...
			await runtime.UPLOADS.put(key, file.stream(), {
				httpMetadata: {
		...
		await db.update(inquiries).set({
			...
			notificationError: error instanceof Error ? error.message.slice(0, 500) : "Attachment storage failed"
	...
	try {
		...
		await db.update(inquiries).set({
			...
			notificationError: error instanceof Error ? error.message.slice(0, 500) : "Notification failed"
		}).where(eq(inquiries.id, id));
	}
...
async function notifyTeam(request, runtime, id, files, details) {
	...
	const expires = Date.now() + 10080 * 60 * 1e3;
	...
	const response = await fetch("https://api.resend.com/emails", {
		...
		body: JSON.stringify({
			from: runtime.INQUIRY_FROM_EMAIL,
			to: [runtime.INQUIRY_TO_EMAIL],
			...details.email ? { reply_to: details.email } : {},
			subject: `SECTION inquiry — ${details.project}`,
			html
		})
	});
...
//#endregion
//#region app/api/inquiry-files/route.ts
...
var Reveal = /* @__PURE__ */ registerClientReference(() => {
	throw new Error("Unexpectedly client reference export 'Reveal' is called on server");
}, "ab0e265b1002", "Reveal");
//#endregion
//#region components/ProcessStory.tsx
var ProcessStory = /* @__PURE__ */ registerClientReference(() => {
	throw new Error("Unexpectedly client reference export 'ProcessStory' is called on server");
}, "3066addfb889", "ProcessStory");
//#endregion
//#region components/ImmersiveWebGL.tsx
var ImmersiveWebGL = /* @__PURE__ */ registerClientReference(() => {
	throw new Error("Unexpectedly client reference export 'ImmersiveWebGL' is called on server");
}, "5fc7428cabbc", "ImmersiveWebGL");
//#endregion
//#region components/ImmersiveProcessStory.tsx
var ImmersiveProcessStory = /* @__PURE__ */ registerClientReference(() => {
	throw new Error("Unexpectedly client reference export 'ImmersiveProcessStory' is called on server");
}, "c731416457b7", "ImmersiveProcessStory");
//#endregion
//#region components/ImmersiveHome.tsx
function ImmersiveHome({ locale }) {
	...
	return /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("main", {
		className: "design-immersive",
		"data-design": "immersive",
		children: [
			/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)(DesignSwitcher, {
				locale,
				current: "immersive"
			...
			/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("header", {
				...
				children: [
					/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)(DesignAwareLink, {
						className: "immersive-wordmark",
						href: `/${locale}`,
						children: /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)(Wordmark, { tone: "light" })
					}),
					/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("nav", {
						...
						children: [
							/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("a", {
								href: "#collections",
								children: isArabic ? "ما نصنعه" : "What we make"
							}),
							/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("a", {
								href: "#process",
								children: isArabic ? "كيف نعمل" : "How it moves"
							}),
							/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("a", {
								href: "#projects",
								children: isArabic ? "المشروعات" : "Projects"
							})
						]
					}),
					/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("div", {
						className: "immersive-header-actions",
						children: [/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)(DesignAwareLink, {
							href: `/${languageTarget}`,
							children: languageTarget.toUpperCase()
						}), /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("a", {
							className: "immersive-header-cta",
							href: "#inquiry",
							children: [isArabic ? "ابدأ مشروعاً" : "Start a project", /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("span", { children: "↗" })]
						})]
					})
				]
			}),
			/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("section", {
				...
				id: "top",
				children: [
					/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)(ImmersiveWebGL, {}),
					/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("div", {
						className: "immersive-hero-noise",
						"aria-hidden": "true"
					}),
					/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("div", {
						className: "immersive-hero-reel",
						"aria-hidden": "true",
						children: /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("div", {
							className: "immersive-hero-reel-track",
							children: [...heroFrames, ...heroFrames].map((media, index) => /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("figure", {
								className: `frame-${index % heroFrames.length}`,
								children: [/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)(image_default, {
									unoptimized: true,
									src: media.src,
									alt: "",
								...
								}), /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("span", { children: ["SECTION / ", String(index % heroFrames.length + 1).padStart(2, "0")] })]
							}, `${media.id}-${index}`))
						})
					}),
					/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("div", {
						className: "immersive-hero-copy",
						children: [
							/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("p", { children: isArabic ? "تصميم / تصنيع / تركيب" : "Design / Manufacture / Install" }),
							/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("h1", { children: isArabic ? /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)(import_jsx_runtime_react_server.Fragment, { children: [
								"نجعل المساحة",
								/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("br", {}),
								/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("em", { children: "ملموسة." })
							] }) : /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)(import_jsx_runtime_react_server.Fragment, { children: [
								"Spaces, made",
								/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("br", {}),
								/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("em", { children: "tangible." })
							] }) }),
							/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("div", {
								className: "immersive-hero-foot",
								children: [/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("span", { children: isArabic ? "من أول فكرة إلى آخر تفصيلة." : "From the first idea to the final fit." }), /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("a", {
									href: "#approach",
									"aria-label": isArabic ? "اكتشف المزيد" : "Explore the page",
									children: [/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("i", { children: "↓" }), isArabic ? "استكشف" : "Enter"]
								})]
							})
						]
					})
			...
			/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("section", {
				className: "immersive-approach",
				id: "approach",
				children: [
					/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("p", {
						className: "immersive-label",
						children: isArabic ? "منهجنا" : "Our approach"
					}),
					/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("h2", { children: isArabic ? /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)(import_jsx_runtime_react_server.Fragment, { children: [
						"خط المعماري",
						/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("br", {}),
						"يصبح ",
						/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("em", { children: "شيئاً حقيقياً." })
					] }) : /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)(import_jsx_runtime_react_server.Fragment, { children: [
						"The architect’s line",
						/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("br", {}),
						"becomes ",
						/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("em", { children: "something real." })
					] }) }),
					/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("div", {
						className: "immersive-approach-body",
						children: [/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("p", { children: isArabic ? "ننسق التفاصيل، نصنع كل عنصر، ونركبه في موقعه. هذا يعني قرارات أقل ضياعاً ونتيجة أكثر تماسكاً." : "We coordinate the detail, make every element and place it on site. Fewer lost decisions. A more coherent result." }), /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("span", { children: isArabic ? "فريق واحد مسؤول" : "One accountable team" })]
					})
				]
			}),
			/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("section", {
				className: "immersive-collections",
				id: "collections",
				children: [/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("div", {
					className: "immersive-collections-intro",
					children: [
						/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("p", {
							className: "immersive-label",
							children: isArabic ? "ما نصنعه" : "What we make"
						}),
						/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("h2", { children: isArabic ? "ثمانية عوالم. خبرة واحدة." : "Eight worlds. One craft." }),
						/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("p", { children: isArabic ? "ادخل من العنصر الذي يحتاجه المشروع." : "Enter through the element your project needs." })
					]
				}), /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("div", {
					className: "immersive-collection-stack",
					children: capabilities.map((capability) => {
						const media = getMedia(capability.image);
						return /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)(DesignAwareLink, {
							className: "immersive-collection",
							href: `/${locale}/collections/${capability.slug}`,
							children: [/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("div", {
								className: "immersive-collection-media",
								children: /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)(image_default, {
									unoptimized: true,
									src: media.src,
								...
								className: "immersive-collection-copy",
								children: [
									/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("span", { children: capability.number }),
									/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("h3", { children: capability.title[locale] }),
									/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("p", { children: capability.short[locale] }),
									/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("b", { children: "Open ↗" })
								]
							})]
						}, capability.slug);
					})
			...
			/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("section", {
				className: "immersive-process",
				id: "process",
				children: [/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("div", {
					className: "immersive-process-title",
					children: [/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("p", {
						className: "immersive-label",
						children: isArabic ? "كيف نعمل" : "How it moves"
					}), /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("h2", { children: isArabic ? /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)(import_jsx_runtime_react_server.Fragment, { children: [
						"أربع حركات.",
						/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("br", {}),
						/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("em", { children: "تسليم واحد." })
					] }) : /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)(import_jsx_runtime_react_server.Fragment, { children: [
						"Four moves.",
						/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("br", {}),
						/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("em", { children: "One handover." })
					] }) })]
				}), /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)(ImmersiveProcessStory, { locale })]
			}),
			/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("section", {
				className: "immersive-projects",
				id: "projects",
				children: [/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("div", {
					className: "immersive-projects-head",
					children: [
						/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("p", {
							className: "immersive-label",
							children: isArabic ? "مشروعات مختارة" : "Selected work"
						}),
						/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("h2", { children: isArabic ? "المشروع هو الدليل." : "The project is the proof." }),
						/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)(DesignAwareLink, {
							href: `/${locale}/projects`,
							children: [isArabic ? "شاهد الكل" : "View all", " ↗"]
						})
					]
				}), /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)(ProjectStoryRail, { locale })]
			}),
			/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("section", {
				className: "immersive-inquiry",
				id: "inquiry",
				children: [/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("div", {
					className: "immersive-inquiry-head",
					children: [
						/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("p", {
							className: "immersive-label",
							children: isArabic ? "الخطوة التالية" : "The next move"
						}),
						/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("h2", { children: isArabic ? /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)(import_jsx_runtime_react_server.Fragment, { children: [
							"لديك فكرة؟",
							/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("br", {}),
							/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("em", { children: "لنجعلها حقيقية." })
						] }) : /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)(import_jsx_runtime_react_server.Fragment, { children: [
							"Have a brief?",
							/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("br", {}),
							/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("em", { children: "Let’s make it real." })
						] }) }),
						/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("p", { children: isArabic ? "اختر ما تحتاجه واترك اسمك ورقمك. سنكمل الحديث معاً." : "Choose what you need, then leave your name and number. We’ll continue the conversation." })
					]
				}), /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)(InquiryForm, { locale })]
			}),
			/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)(PartnerMarquee, { locale }),
			/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("footer", {
				...
				children: [
					/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("span", { children: "SECTION © 2026" }),
					/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("span", { children: isArabic ? "صُنع في القاهرة" : "MADE IN CAIRO" }),
					/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("a", {
						href: "#top",
						children: [isArabic ? "إلى الأعلى" : "BACK TO ORBIT", " ↑"]
					})
				]
			})
		]
...
var AdaptiveWebGL = /* @__PURE__ */ registerClientReference(() => {
	throw new Error("Unexpectedly client reference export 'AdaptiveWebGL' is called on server");
}, "b178cf627e26", "AdaptiveWebGL");
//#endregion
//#region components/ShowroomProcess.tsx
var ShowroomProcess = /* @__PURE__ */ registerClientReference(() => {
	throw new Error("Unexpectedly client reference export 'ShowroomProcess' is called on server");
}, "5297feacba07", "ShowroomProcess");
//#endregion
//#region components/ShowroomHome.tsx
function ShowroomHome({ locale, mode }) {
	const t = copy[locale];
	const dark = mode === "nocturne";
	const title = locale === "ar" ? dark ? /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)(import_jsx_runtime_react_server.Fragment, { children: [
		"مساحات ",
		/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("em", { children: "تظهر" }),
		" في الضوء."
	] }) : /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)(import_jsx_runtime_react_server.Fragment, { children: ["من الفكرة إلى ", /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("em", { children: "قطعة متكاملة." })] }) : dark ? /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)(import_jsx_runtime_react_server.Fragment, { children: [
		"Spaces ",
		/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("em", { children: "revealed" }),
		" in light."
	] }) : /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)(import_jsx_runtime_react_server.Fragment, { children: ["From first line to ", /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("em", { children: "final assembly." })] });
	...
	return /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("main", {
		className: `showroom-home design-${mode}`,
		"data-design": mode,
		children: [
			/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)(DesignSwitcher, {
				locale,
			...
			/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("section", {
				...
				children: [
					/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)(image_default, {
						unoptimized: true,
						className: "showroom-hero-poster",
						src: poster,
						alt: "",
						fill: true,
						priority: true,
					...
					/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)(AdaptiveWebGL, { mode }),
					/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("div", {
						className: "showroom-hero-grid",
						"aria-hidden": "true",
						children: [
					...
					/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("div", {
						className: "showroom-hero-copy",
						children: [
							/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("p", { children: dark ? "SECTION / MATERIAL THEATRE" : "SECTION / DESIGN · MAKE · INSTALL" }),
							/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("h1", { children: title }),
							/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("div", { children: [/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("span", { children: body }), /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)(DesignAwareLink, {
								href: `/${locale}/inquiry`,
								children: [t.hero.primary, " ↗"]
							})] })
						]
					}),
					/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("div", {
						className: "showroom-hero-proof",
						"aria-label": locale === "ar" ? "عملاء مختارون" : "Selected client work",
						children: [
							/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("span", { children: locale === "ar" ? "أعمال مختارة مع" : "Selected work with" }),
							/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("strong", { children: "SODIC" }),
							/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("i", { children: "+" }),
							/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("strong", { children: "ORA" })
						]
					})
				]
			}),
			/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("section", {
				className: "showroom-statement",
				children: [
					/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("p", { children: ["01 / ", locale === "ar" ? "فريق واحد" : "One accountable team"] }),
					/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("h2", { children: locale === "ar" ? /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)(import_jsx_runtime_react_server.Fragment, { children: ["المشروع يتحرك في ", /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("em", { children: "خط واحد." })] }) : /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)(import_jsx_runtime_react_server.Fragment, { children: ["The project moves through ", /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("em", { children: "one line." })] }) }),
					/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("span", { children: locale === "ar" ? "من موجز العمل إلى التصميم والتصنيع والتركيب—مع مراجعة كل انتقال." : "From brief to design, manufacturing and installation—with every handoff checked." })
				]
			}),
			/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("section", {
				className: "showroom-collections",
				id: "capabilities",
				children: [/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("header", { children: [/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("p", { children: ["02 / ", t.capabilities.eyebrow] }), /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("h2", { children: t.capabilities.title })] }), /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("div", {
					className: "showroom-collection-list",
					children: capabilities.map((capability, index) => {
						const media = getMedia(capability.image);
						return /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)(DesignAwareLink, {
							href: `/${locale}/collections/${capability.slug}`,
							className: "showroom-collection-row",
							children: [
								/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("span", { children: String(index + 1).padStart(2, "0") }),
								/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("h3", { children: capability.title[locale] }),
								/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("p", { children: capability.short[locale] }),
								/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("div", { children: /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)(image_default, {
									unoptimized: true,
									src: media.src,
									alt: media.alt[locale],
									fill: true,
			...
			/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)(ShowroomProcess, {
				locale,
				mode
			}),
			/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("section", {
				className: "showroom-projects",
				children: [/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("header", { children: [/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("p", { children: ["04 / ", t.projects.eyebrow] }), /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("h2", { children: locale === "ar" ? /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)(import_jsx_runtime_react_server.Fragment, { children: ["الثقة تُبنى من ", /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("em", { children: "العمل." })] }) : /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)(import_jsx_runtime_react_server.Fragment, { children: ["Trust is built through ", /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("em", { children: "the work." })] }) })] }), /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)(ProjectStoryRail, { locale })]
			}),
			/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("section", {
				className: "showroom-manufacturing",
				children: [/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("div", {
					className: "showroom-manufacturing-media",
					children: [
						/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)(image_default, {
							unoptimized: true,
							src: "/drive/materials/material-01.webp",
							alt: locale === "ar" ? "مراجعة عينة خشبية بعلامة SECTION" : "A SECTION-labelled timber sample under review",
							fill: true,
							sizes: "(max-width: 760px) 100vw, 52vw"
						}),
						/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("figure", { children: /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)(image_default, {
							unoptimized: true,
							src: "/drive/materials/material-03.webp",
							alt: locale === "ar" ? "مكتبة عينات للقشرة والتشطيبات" : "Veneer and finish sample library",
							fill: true,
							sizes: "240px"
						}) }),
						/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("figure", { children: /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)(image_default, {
							unoptimized: true,
							src: "/drive/materials/material-07.webp",
							alt: locale === "ar" ? "مراجعة عينات التشطيب يدوياً" : "Finishes being reviewed by hand",
							fill: true,
							sizes: "240px"
						}) })
					]
				}), /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("div", { children: [
					/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("p", { children: ["05 / ", locale === "ar" ? "الخامة والتصنيع" : "Material & manufacturing"] }),
					/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("h2", { children: locale === "ar" ? "نختار بالعين. ونثبت باليد." : "Chosen by eye. Proven by hand." }),
					/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("span", { children: locale === "ar" ? "نراجع الألواح والقشرة والتشطيبات والإكسسوارات كعينات فعلية قبل الإنتاج، حتى تتوافق الدرجة والملمس وقابلية التنفيذ مع موجز المشروع." : "Boards, veneers, finishes and hardware are reviewed as physical samples before production, aligning tone, texture and buildability with the project brief." }),
					/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("ol", { children: (locale === "ar" ? [
						"مكتبات تشطيبات منسقة",
						"عينات واعتمادات فعلية",
						"مراجعة قبل بدء الإنتاج"
					] : [
						"Curated finish libraries",
						"Physical samples and approvals",
						"Review before production"
					]).map((fact, index) => /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("li", { children: [/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("b", { children: ["0", index + 1] }), fact] }, fact)) })
				] })]
			}),
			/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("section", {
				className: "showroom-about",
				id: "studio",
				children: [
					/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("p", { children: ["06 / ", locale === "ar" ? "عن SECTION" : "About SECTION"] }),
					/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("h2", { children: locale === "ar" ? /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)(import_jsx_runtime_react_server.Fragment, { children: ["الخشب هو الخامة. ", /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("em", { children: "والمكان هو القصة." })] }) : /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)(import_jsx_runtime_react_server.Fragment, { children: ["Wood is the medium. ", /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("em", { children: "The space is the story." })] }) }),
					/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("div", {
						className: "showroom-about-copy",
						children: [/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("p", { children: locale === "ar" ? "نرشد المشروع من أول محادثة حتى التركيب النهائي، ونحوّل الرؤية إلى عناصر خشبية مصممة للمقاس تجمع بين الجمال والوظيفة والمتانة." : "We guide a project from the first conversation to final installation, turning the brief into made-to-fit timber interiors that balance beauty, function and durability." }), /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("p", { children: locale === "ar" ? "رؤيتنا أن نكون شريكاً موثوقاً للتصميم والتصنيع؛ نصنع مساحات ذات غرض واضح، تعكس هوية المشروع وتدوم بشكل جميل." : "Our vision is to be a trusted design-and-manufacturing partner: creating purposeful spaces that carry the project’s identity and last beautifully." })]
					}),
					/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("blockquote", { children: locale === "ar" ? "أعد التفكير في التصميم. اروِ قصة المكان." : "Rethink the design. Tell the story of the space." })
				]
			}),
			/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("section", {
				className: "showroom-inquiry",
				id: "inquiry",
				children: [/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("header", { children: [
					/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("p", { children: ["07 / ", locale === "ar" ? "ابدأ من هنا" : "Start here"] }),
					/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("h2", { children: locale === "ar" ? /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)(import_jsx_runtime_react_server.Fragment, { children: ["ما الذي تريد أن ", /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("em", { children: "نصنعه؟" })] }) : /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)(import_jsx_runtime_react_server.Fragment, { children: ["What should we ", /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("em", { children: "make together?" })] }) }),
					/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("span", { children: locale === "ar" ? "اختر المطلوب في خطوات قصيرة. الاسم ورقم الهاتف فقط مطلوبان." : "Qualify the request in a few simple choices. Only your name and phone are required." })
				] }), /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)(InquiryForm, { locale })]
			})
		]
	});
...
async function HomePage({ params, searchParams }) {
	...
	if (!isLocale(locale)) notFound();
	const design = getDesign((await searchParams)?.design);
	if (design === "immersive") return /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)(ImmersiveHome, { locale });
	if (design === "assemblage" || design === "nocturne") return /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)(ShowroomHome, {
		locale,
		mode: design
	});
	const t = copy[locale];
		...
		children: [
				...
				children: [
					/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("div", {
						...
						children: [
							...
							/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("div", { className: "hero-shade" }),
							/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("span", {
								className: "hero-frame-code",
					...
					/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("div", {
						...
						children: [
							...
							/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("h1", {
								"aria-label": t.hero.title.replace("\n", " "),
								children: locale === "ar" ? /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)(import_jsx_runtime_react_server.Fragment, { children: [/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("span", { children: ["مصنوع من ", /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("em", { children: "الخشب." })] }), /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("span", { children: [
									"لمساحات ",
									/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("em", { children: "بطموح" }),
									" كبير."
								] })] }) : /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)(import_jsx_runtime_react_server.Fragment, { children: [
									/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("span", { children: ["Made with ", /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("em", { children: "wood." })] }),
									/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("span", { children: ["Built for ", /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("em", { children: "ambitious" })] }),
									/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("span", { children: "spaces." })
								] })
							}),
							/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("div", {
								className: "hero-bottom",
								children: [/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("p", { children: t.hero.body }), /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("div", {
									className: "hero-actions",
									children: [/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)(DesignAwareLink, {
										className: "button-primary",
										href: "#inquiry",
										children: [t.hero.primary, /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("span", { children: "↘" })]
									}), /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)(DesignAwareLink, {
										className: "text-link light",
										href: `/${locale}/projects`,
										children: [t.hero.secondary, /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("span", { children: "↓" })]
									})]
								})]
							})
						]
					...
					/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("span", {
						...
						children: ["SCROLL ", /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("i", {})]
					})
				]
			}),
			/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("section", {
				...
				children: [
					/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)(Reveal, {
						className: "proof-number",
						children: "01"
					}),
					/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)(Reveal, {
						className: "proof-copy",
						children: [
							/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("p", {
								className: "eyebrow",
								children: t.proof.eyebrow
							}),
							/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("h2", { children: locale === "ar" ? /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)(import_jsx_runtime_react_server.Fragment, { children: ["من أول خط إلى ", /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("em", { children: "آخر تركيب." })] }) : /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)(import_jsx_runtime_react_server.Fragment, { children: ["From first line to ", /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("em", { children: "final fit." })] }) }),
							/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("p", { children: t.proof.body })
						]
					}),
					/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)(Reveal, {
						className: "proof-mark",
						delay: .12,
						children: [/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("span", { children: "SECTION" }), /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("small", { children: "DESIGN / MAKE / DELIVER" })]
					})
				]
			}),
			/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("section", {
				className: "featured-project section-pad",
				id: "work",
				children: [/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("div", {
					className: "section-heading split",
					children: [/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("div", { children: [/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("p", {
						className: "eyebrow",
						children: t.featured.eyebrow
					}), /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("h2", { children: locale === "ar" ? /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)(import_jsx_runtime_react_server.Fragment, { children: ["المشروع يروي ", /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("em", { children: "القصة." })] }) : /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)(import_jsx_runtime_react_server.Fragment, { children: ["The project tells ", /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("em", { children: "the story." })] }) })] }), /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("span", { children: ["02 — ", featured.sectorLabel[locale]] })]
				}), /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)(Reveal, {
					...
					children: [
						...
						/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("div", {
							...
							children: [
								/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("p", { children: featured.client[locale] }),
								/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("h3", { children: featured.title[locale] }),
								/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("span", { children: featured.location[locale] })
							]
						}),
						/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)(DesignAwareLink, {
							href: `/${locale}/projects/${featured.slug}`,
							"aria-label": t.featured.link,
							children: [t.featured.link, /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("span", { children: "↗" })]
						})
					]
				})]
			}),
			/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("section", {
				...
				children: [/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("div", {
					...
					children: [/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("div", { children: [/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("p", {
						className: "eyebrow",
						children: t.capabilities.eyebrow
					}), /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("h2", { children: locale === "ar" ? /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)(import_jsx_runtime_react_server.Fragment, { children: ["استكشف ", /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("em", { children: "الأعمال." })] }) : /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)(import_jsx_runtime_react_server.Fragment, { children: ["Explore the ", /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("em", { children: "work." })] }) })] }), /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("p", { children: t.capabilities.body })]
				}), /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("div", {
			...
			/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("section", {
				className: "process-intro section-pad",
				id: "process",
				children: [
					...
					}), /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("h2", { children: locale === "ar" ? /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)(import_jsx_runtime_react_server.Fragment, { children: ["أربع مراحل. ", /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("em", { children: "خط واحد." })] }) : /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)(import_jsx_runtime_react_server.Fragment, { children: ["Four moves. ", /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("em", { children: "One line." })] }) })] }),
					/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("p", { children: t.process.body }),
					/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("span", { children: locale === "ar" ? "٤ مراحل" : "4 STAGES" })
				]
			}),
			/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)(ProcessStory, { locale }),
			/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("section", {
				className: "factory-section",
				id: "studio",
				children: [/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("div", {
					className: "factory-media",
					children: /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)(image_default, {
						unoptimized: true,
						src: factory.src,
						alt: factory.alt[locale],
						fill: true,
						sizes: "(max-width: 800px) 100vw, 55vw"
					})
				}), /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)(Reveal, {
					className: "factory-copy",
					children: [
						/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("p", {
							className: "eyebrow",
							children: t.factory.eyebrow
						}),
						/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("h2", { children: locale === "ar" ? /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)(import_jsx_runtime_react_server.Fragment, { children: ["نصنع هنا. ", /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("em", { children: "ونراجع هنا." })] }) : /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)(import_jsx_runtime_react_server.Fragment, { children: ["Made here. ", /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("em", { children: "Checked here." })] }) }),
						/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("p", { children: t.factory.body }),
						/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("ol", { children: t.factory.facts.map((fact, index) => /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("li", { children: [/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("span", { children: ["0", index + 1] }), fact] }, fact)) })
					]
				})]
			}),
			/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("section", {
				...
				children: [/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("div", {
					...
					children: [/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("div", { children: [/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("p", {
						className: "eyebrow",
						children: t.projects.eyebrow
					}), /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("h2", { children: locale === "ar" ? /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)(import_jsx_runtime_react_server.Fragment, { children: ["أعمال تستحق ", /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("em", { children: "أن تفتحها." })] }) : /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)(import_jsx_runtime_react_server.Fragment, { children: ["Work worth ", /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("em", { children: "opening." })] }) })] }), /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("p", { children: t.projects.body })]
				}), /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)(ProjectStoryRail, { locale })]
			}),
			/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("section", {
				className: "materials-section section-pad",
				children: [/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)(Reveal, {
					className: "materials-copy",
					children: [
						/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("p", {
							className: "eyebrow",
							children: t.materials.eyebrow
						}),
						/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("h2", { children: locale === "ar" ? /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)(import_jsx_runtime_react_server.Fragment, { children: ["مختارة ", /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("em", { children: "لتدوم." })] }) : /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)(import_jsx_runtime_react_server.Fragment, { children: ["Chosen to ", /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("em", { children: "last." })] }) }),
						/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("p", { children: t.materials.body })
					]
				}), /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("div", {
					className: "material-list",
					children: t.materials.items.map((item, index) => /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)(Reveal, {
						className: "material-row",
						delay: index * .05,
						children: [
							/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("span", { children: ["0", index + 1] }),
							/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("p", { children: item }),
							/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("i", {})
						]
					}, item))
				})]
			...
			/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("section", {
				className: "closing-cta section-pad",
				children: [
					/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("p", {
						className: "eyebrow",
						children: t.close.eyebrow
					}),
					/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("h2", { children: locale === "ar" ? /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)(import_jsx_runtime_react_server.Fragment, { children: ["أرسل لنا ", /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("em", { children: "المتطلبات." })] }) : /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)(import_jsx_runtime_react_server.Fragment, { children: ["Bring us ", /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("em", { children: "the brief." })] }) }),
					/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("div", { children: [/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("p", { children: t.close.body }), /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)(DesignAwareLink, {
						className: "button-yellow",
						href: "#inquiry",
						children: [t.close.action, /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("span", { children: "↘" })]
					})] })
				]
			}),
			/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("section", {
				className: "landing-inquiry section-pad",
				id: "inquiry",
				children: [/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("div", {
					className: "section-heading split",
					children: [/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("div", { children: [/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("p", {
						className: "eyebrow",
						children: locale === "ar" ? "ابدأ من هنا" : "Start here"
					}), /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("h2", { children: locale === "ar" ? /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)(import_jsx_runtime_react_server.Fragment, { children: ["قل لنا ما ", /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("em", { children: "تحتاجه." })] }) : /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)(import_jsx_runtime_react_server.Fragment, { children: ["Tell us what ", /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("em", { children: "you need." })] }) })] }), /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("p", { children: locale === "ar" ? "خطوات قصيرة تساعدنا على فهم المطلوب. الاسم ورقم الهاتف فقط إلزاميان." : "A few easy choices help us understand the ask. Only your name and phone are required." })]
				}), /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)(InquiryForm, { locale })]
			})
		]
	});
...
//#endregion
//#region app/manifest.ts
var manifest_exports = /* @__PURE__ */ __exportAll({ default: () => manifest });
function manifest() {
	return {
...
function localizedEntry(locale, path, priority, changeFrequency) {
	return {
		url: absoluteUrl(localePath(locale, path)),
...
function sitemap() {
	return locales.flatMap((locale) => [
		...
		localizedEntry(locale, "/projects", .9, "monthly"),
		...projects.map((project) => localizedEntry(locale, `/projects/${project.slug}`, .8, "monthly")),
		...capabilities.map((capability) => localizedEntry(locale, `/collections/${capability.slug}`, .85, "monthly")),
		localizedEntry(locale, "/inquiry", .65, "yearly")
	]);
}
//#endregion
...
var routes = [
	{
		...
		ids: {
			"route": "route:/:locale/inquiry",
			"page": "page:/:locale/inquiry",
			"routeHandler": null,
		...
		pattern: "/:locale/inquiry",
		patternParts: [":locale", "inquiry"],
		isDynamic: true,
		params: ["locale"],
	...
	},
	{
		...
		ids: {
			"route": "route:/:locale/projects",
			"page": "page:/:locale/projects",
			"routeHandler": null,
			"rootBoundary": "root-boundary:/[locale]",
			"layouts": ["layout:/[locale]"],
			"templates": [],
	...
	},
	{
		...
		ids: {
			"route": "route:/:locale/capabilities/:slug",
			"page": "page:/:locale/capabilities/:slug",
			"routeHandler": null,
			"rootBoundary": "root-boundary:/[locale]",
			"layouts": ["layout:/[locale]"],
			"templates": [],
		...
		pattern: "/:locale/capabilities/:slug",
		patternParts: [
			":locale",
			"capabilities",
			":slug"
	...
	},
	{
		...
		ids: {
			"route": "route:/:locale/collections/:slug",
			"page": "page:/:locale/collections/:slug",
			"routeHandler": null,
			"rootBoundary": "root-boundary:/[locale]",
			"layouts": ["layout:/[locale]"],
			"templates": [],
		...
		pattern: "/:locale/collections/:slug",
		patternParts: [
			":locale",
			"collections",
			":slug"
	...
	},
	{
		...
		ids: {
			"route": "route:/:locale/projects/:slug",
			"page": "page:/:locale/projects/:slug",
			"routeHandler": null,
			"rootBoundary": "root-boundary:/[locale]",
			"layouts": ["layout:/[locale]"],
			"templates": [],
	...
	},
	{
		...
		ids: {
			...
			"page": "page:/",
			"routeHandler": null,
			"rootBoundary": "root-boundary:/(root)",
			"layouts": ["layout:/(root)"],
			"templates": [],
			"slots": {}
		},
	...
	},
	{
		...
		ids: {
			"route": "route:/api/inquiries",
			"page": null,
			"routeHandler": "route-handler:/api/inquiries",
			"rootBoundary": null,
			"layouts": [],
			"templates": [],
			"slots": {}
	...
	},
	{
		...
		ids: {
			"route": "route:/api/inquiry-files",
			"page": null,
			"routeHandler": "route-handler:/api/inquiry-files",
			"rootBoundary": null,
			"layouts": [],
			"templates": [],
			"slots": {}
		},
		pattern: "/api/inquiry-files",
		patternParts: ["api", "inquiry-files"],
		isDynamic: false,
		params: [],
		rootParamNames: [],
		page: null,
		...
		layouts: [],
		routeSegments: ["api", "inquiry-files"],
		templateTreePositions: [],
		layoutTreePositions: [],
		templates: [],
		errors: [],
...
var metadataRoutes = [
	{
		...
		contentHash: "c5ac24cf52f77f60",
		headData: {
			"kind": "manifest",
			"href": "/manifest.webmanifest"
		},
		module: manifest_exports
	},
	{
		type: "robots",
		isDynamic: true,
...
var __publicFiles = new Set([
	...
	"/assets/412078_605141.jpeg",
	"/assets/474743_155959.jpg",
	"/assets/805180_442982.jpeg",
	"/assets/866856_780182.png",
	"/assets/891416_45535.jpg",
	"/assets/old-site-home.png",
	"/brand/section-black.png",
	"/brand/section-white.png",
	"/drive/dressing/dressing-01.webp",
	"/drive/dressing/dressing-02.webp",
	"/drive/dressing/dressing-03.webp",
	"/drive/dressing/dressing-04.webp",
	"/drive/dressing/dressing-05.webp",
	"/drive/dressing/dressing-06.webp",
	"/drive/dressing/dressing-07.webp",
	"/drive/dressing/dressing-08.webp",
	"/drive/kitchens/kitchen-01-a.webp",
	"/drive/kitchens/kitchen-01-b.webp",
	"/drive/kitchens/kitchen-01-c.webp",
	"/drive/kitchens/kitchen-01-d.webp",
	"/drive/kitchens/kitchen-01-e.webp",
	"/drive/kitchens/kitchen-01-f.webp",
	"/drive/kitchens/kitchen-01-g.webp",
	"/drive/kitchens/kitchen-02-a.webp",
	"/drive/kitchens/kitchen-02-b.webp",
	"/drive/kitchens/kitchen-02-c.webp",
	"/drive/kitchens/kitchen-02-d.webp",
	"/drive/kitchens/kitchen-02-e.webp",
	"/drive/kitchens/kitchen-02-f.webp",
	"/drive/kitchens/kitchen-03-a.webp",
	"/drive/kitchens/kitchen-03-b.webp",
	"/drive/kitchens/kitchen-04-a.webp",
	"/drive/kitchens/kitchen-04-b.webp",
	"/drive/kitchens/kitchen-05-a.webp",
	"/drive/kitchens/kitchen-05-b.webp",
	"/drive/kitchens/kitchen-05-c.webp",
	"/drive/kitchens/kitchen-05-d.webp",
	"/drive/materials/material-01.webp",
	"/drive/materials/material-02.webp",
	"/drive/materials/material-03.webp",
	"/drive/materials/material-04.webp",
	"/drive/materials/material-05.webp",
	"/drive/materials/material-06.webp",
	"/drive/materials/material-07.webp",
	"/drive/partners-transparent/partner-01.png",
	"/drive/partners-transparent/partner-02.png",
	"/drive/partners-transparent/partner-03.png",
	"/drive/partners-transparent/partner-04.png",
	"/drive/partners-transparent/partner-05.png",
	"/drive/partners-transparent/partner-06.png",
	"/drive/partners-transparent/partner-07.png",
	"/drive/partners-transparent/partner-08.png",
	"/drive/partners-transparent/partner-09.png",
	"/drive/partners/partner-01.webp",
	"/drive/partners/partner-02.webp",
	"/drive/partners/partner-03.webp",
	"/drive/partners/partner-04.webp",
	"/drive/partners/partner-05.webp",
	"/drive/partners/partner-06.webp",
	"/drive/partners/partner-07.webp",
	"/drive/partners/partner-08.webp",
	"/drive/partners/partner-09.webp",
	"/favicon.svg",
	"/file.svg",
	"/globe.svg",
	"/og-showroom.jpg",
...
var _virtual_vinext_rsc_entry_default = createAppRscHandler({
	...
	rootParamNamesByPattern: {
		...
		"/:locale/capabilities/:slug": ["locale"],
		"/:locale/collections/:slug": ["locale"],
		"/:locale/projects/:slug": ["locale"],
		"/:locale": ["locale"]
	},
	setNavigationContext: setAppNavigationContext,
	staticParamsMap: {
		"/:locale/inquiry": null,
		"/:locale/projects": null,
		"/:locale/capabilities/:slug": null,
		"/:locale/collections/:slug": generateStaticParams$1 ?? null,
		"/:locale/projects/:slug": generateStaticParams ?? null,
		"/:locale": null
	},
