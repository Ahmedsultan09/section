globalThis.__VINEXT_LAZY_CHUNKS__ = ["assets/react-DAvIGDRQ.js","assets/site-content-B0PlJOAT.js","assets/ImmersiveProcessStory-gJi2AzTP.js","assets/ImmersiveWebGL-Dcrb9wb5.js","assets/InquiryForm-41Ju1zLl.js","assets/LocaleSwitch-DKlMe6Sq.js","assets/ProcessStory-BKFBNYnA.js","assets/ProjectExplorer-CZkc7P5u.js","assets/Reveal-BCR8A-iT.js","assets/image-BB24ok5U.js","assets/layout-segment-context-Bm4iUqFo.js","assets/link-DrnK9bpv.js","assets/router-DBGqX9W5.js"];
...
function getDraftSecret() {
	return "2aa54422-cd19-4b65-af56-e865919395bd";
}
/**
...
var NextURL = class NextURL {
	...
	*/
	get buildId() {
		return "b665d5cc-fd55-4ec5-afea-52f171b0939f";
	}
};
...
*/
function appIsrCacheKey(pathname, suffix, buildId = "b665d5cc-fd55-4ec5-afea-52f171b0939f") {
...
function createAppPageArtifactCompatibility(element, routePattern) {
	...
	return createArtifactCompatibilityEnvelope({
		...
		deploymentVersion: "b665d5cc-fd55-4ec5-afea-52f171b0939f",
		rootBoundaryId
	});
}
/**
		...
		children: [
			...
			/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("aside", {
				...
				children: [
					...
					/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("p", { children: locale === "ar" ? "اختيارات بسيطة ثم الاسم ورقم الهاتف. إذا لم تكن متأكداً بعد، سنساعدك في الخطوة التالية." : "A few simple choices, then your name and phone. If you are not sure yet, we can help shape the next step." }),
					...
					/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("div", { children: [/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("span", { children: "02" }), locale === "ar" ? "يمكنك إضافة ملاحظات أو ملفات اختيارياً" : "Notes and files are optional"] })
				]
			}),
	...
	return /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("header", {
		...
		children: [
			...
			/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("div", {
				...
				children: [/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)(LocaleSwitch, { locale }), /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)(link_default, {
...
async function ProjectsPage({ params }) {
	...
	if (!isLocale(locale)) notFound();
	return /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("main", {
		className: "subpage projects-page",
		children: [
			/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)(JsonLd, { data: [breadcrumbSchema(locale, [{
				name: locale === "ar" ? "الرئيسية" : "Home",
				path: ""
			...
			/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("header", {
				...
				children: [
					...
					/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("p", { children: locale === "ar" ? "تصفح حسب القطاع. تُنشر أسماء العملاء والبيانات المؤكدة فقط بعد الاعتماد." : "Browse by sector. Client names and confirmed facts are published only after approval." })
				]
			}),
...
async function CollectionPage({ params }) {
	...
	return /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("main", {
		className: "capability-detail subpage",
		children: [
			/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)(JsonLd, { data: [serviceSchema(locale, collection), breadcrumbSchema(locale, [
				{
					name: locale === "ar" ? "الرئيسية" : "Home",
					path: ""
				},
			...
			related.length > 0 && /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("section", {
				...
				}), related.map((project) => /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)(link_default, {
...
async function ProjectPage({ params }) {
	...
	return /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("main", {
		className: "project-detail subpage",
		children: [
...
function DesignSwitcher({ locale, current }) {
	const isArabic = locale === "ar";
	return /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("nav", {
		className: "design-switcher",
		"aria-label": isArabic ? "اختيار اتجاه التصميم" : "Design direction",
		children: [
			/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("span", { children: isArabic ? "الاتجاه" : "View" }),
			/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)(link_default, {
				className: current === "editorial" ? "active" : "",
				href: `/${locale}?design=editorial`,
				children: isArabic ? "تحريري" : "Editorial"
			}),
			/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)(link_default, {
				className: current === "immersive" ? "active" : "",
				href: `/${locale}?design=immersive`,
				children: isArabic ? "تفاعلي" : "Immersive"
			})
		]
	});
}
		...
		children: [
				...
				children: [
					...
					/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("div", {
						...
						children: [/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)(link_default, {
							href: `/${languageTarget}?design=immersive`,
			...
			/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("section", {
				...
				children: [/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("div", {
					...
					className: "immersive-project-rail",
						...
						return /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)(link_default, {
							...
							children: [
								/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("div", { children: /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)(image_default, {
									...
									alt: media.alt[locale],
									fill: true,
									sizes: "(max-width: 780px) 86vw, 54vw"
								}) }),
								/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("span", { children: project.sectorLabel[locale] }),
								/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("h3", { children: project.title[locale] }),
								/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("p", { children: project.summary[locale] })
							]
						}, project.slug);
					})
				})]
...
async function HomePage({ params, searchParams }) {
	const { locale } = await params;
	if (!isLocale(locale)) notFound();
	const design = (await searchParams)?.design === "immersive" ? "immersive" : "editorial";
		...
		children: [
			...
			/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("section", {
				...
				children: [
					...
					/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("div", { children: [/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("p", { children: t.close.body }), /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)(link_default, {
						className: "button-yellow",
						href: "#inquiry",
